    ...
    <div className="grid grid-cols-12 gap-2 items-center">
      ...
      <div className="col-span-4">
        <input
          ...
          value={set.weight || ''}
          onChange={(e) =>
            onUpdateSet(seriesId, exerciseId, set.id, 'weight', Number(e.target.value))
          }
        />
      </div>
      ...
      <div className="col-span-4">
        {set.type === 'failure' ? (
          ...
          <input
            ...
            value={set.reps || ''}
            onChange={(e) =>
              onUpdateSet(seriesId, exerciseId, set.id, 'reps', Number(e.target.value))
            }
          />
        )}
      </div>
        ...
        <button
          ...
          onClick={() =>
            onUpdateSet(
              ...
              set.id,
              'type',
              set.type === 'failure' ? 'working' : 'failure'
            )
          }
          className={cn(
            'transition-colors',
